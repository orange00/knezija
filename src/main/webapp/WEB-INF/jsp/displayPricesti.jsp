...
<c:choose>
	<c:when test="${isArchive}">
		<title>Arhiva - Prva Pričest</title>
	</c:when>
	<c:otherwise>
		<title>Upisnice za Prvu Pričest</title>
	</c:otherwise>
</c:choose>
</head>
<body>
		...
		<div class="col-md-2">
			...
			<c:if test="${not isArchive}">
				<div class="col-md-3">
					<!-- 							excel icon -->
					<a
						href="/knezija/sakramenti/pricest/display-prijave/generate-excel-all"><img
						src="/knezija/collections/11/content/41/image/40"
						title="generiraj excel tablicu sa svim upisnicama"></a>
				</div>
				<div class="col-md-3">
					<!-- 							email icon -->
					<a href="/knezija/sakramenti/pricest/display-prijave/send-email"><img
						src="/knezija/collections/11/content/42/image/40"
						title="posalji email svima"></a>
				</div>
				<!-- 							archive icon -->
				<div class="col-md-3">
					<a href="/knezija/sakramenti/pricest/display-prijave/archive"><img
			...
			<c:if test="${isArchive}">
				<div class="col-md-3">
					<!-- 							excel icon -->
					<a
						href="/knezija/sakramenti/pricest/display-prijave/archive/generate-excel-all"><img
						src="/knezija/collections/11/content/41/image/40"
						title="generiraj excel tablicu sa svim upisnicama"></a>
				</div>
				<div class="col-md-3">
					<!-- 							email icon -->
					<a
						href="/knezija/sakramenti/pricest/display-prijave/archive/send-email"><img
						src="/knezija/collections/11/content/42/image/40"
						title="posalji email svima"></a>
				</div>
			</c:if>
	...
	<div class="row">
		<div class="row left-screen-margin-20">
			<div class="col-md-8">
				<div class="col-md-2">
					<label><i>Ime prvopričesnika</i></label>
				</div>
				<div class="col-md-2">
					<label><i>Prezime prvopričesnika</i></label>
				</div>
				<div class="col-md-2">
				...
				<div class="col-md-3">
					<label><i>Datum pričesti</i></label>
				</div>
			</div>
			<div class="col-md-4">
				<div class="col-md-6">
		...
		<c:forEach items="${stavke}" var="pricest">
			<form role="form" method="POST"
				action="/knezija/sakramenti/pricest/prijava/${pricest.id}/save-datum-pricesti">
				<div class="row left-screen-margin-15">
					<div class="col-md-8">
						<div class="col-md-2">
							<input class="form-control"
								style="background:${pricest.inputColor};" readonly="readonly"
								value="${pricest.imeDjeteta}">
						</div>
						<div class="col-md-2">
							<input class="form-control"
								style="background:${pricest.inputColor};" readonly="readonly"
								value="${pricest.prezimeDjeteta}">
						</div>
						<div class="col-md-2">
							<input class="form-control"
								style="background:${pricest.inputColor};" readonly="readonly"
								value="${pricest.brojTelefona}">
						</div>
						<div class="col-md-3">
							<input class="form-control" type="date"
								style="background:${pricest.inputColor};" readonly="readonly"
								value="${pricest.datumPrijave}">
						</div>
						<div class="col-md-3">
							<input class="form-control" style="background:${pricest.inputColor};" type="date" name="datumPricesti"
								value="${pricest.datumKrizme}">
						</div>
					</div>
					<div class="col-md-4">
						<div class="col-md-2">
						...
						<div class="col-md-3">
							<a href="/knezija/sakramenti/pricest/prijava/${pricest.id}"><button
						...
						<div class="col-md-5">
							<div class="col-md-4">
								<!-- 							word icon -->
								<a
									href="/knezija/sakramenti/pricest/prijava/${pricest.id}/generate-word"><img
									src="/knezija/collections/11/content/29/image/40"
									title="generiraj word dokument"></a>
							</div>
							<div class="col-md-4">
								<!-- 							email icon -->
								<a href="/knezija/send-email/${pricest.email}"><img
									src="/knezija/collections/11/content/42/image/40"
							...
							<c:if test="${not isArchive}">
								<div class="col-md-4">
									...
									<a
										href="/knezija/sakramenti/pricest/prijava/${pricest.id}/send-to-archive"><img
										src="/knezija/collections/11/content/45/image/40"
										title="arhiviraj"></a>
								</div>
							</c:if>
						...
						<div class="col-md-1">
							...
							<a
								href="/knezija/sakramenti/pricest/prijava/${pricest.id}/delete"><img
	...
	<script>
		var archiveSyncAction = "/knezija/sakramenti/pricest/display-prijave/archive/synchronize";
		var activeRecordsSyncAction = "/knezija/sakramenti/pricest/display-prijave/synchronize";
	</script>
